package com.buildworld.graphics.colors;
 ...
 *
 */
public class RGBAColor implements Colorable {

    public static final RGBAColor WHITE = new RGBAColor(1f, 1f, 1f);
    ...
    /**
     * Creates a RGB-RGBAColor with an alpha value of 1.
     *
