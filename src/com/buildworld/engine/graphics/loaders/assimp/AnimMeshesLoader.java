...
public class AnimMeshesLoader extends StaticMeshesLoader {
    ...
    private static Mesh processMesh(AIMesh aiMesh, List<Material> materials, List<Bone> boneList) {
        ...
        Mesh mesh = new Mesh(FileUtils.listToArray(vertices), FileUtils.listToArray(textures),
                FileUtils.listToArray(normals), FileUtils.listIntToArray(indices),
                FileUtils.listIntToArray(boneIds), FileUtils.listToArray(weights));
        Material material;
